...
def execute_review_pipeline():
    ...
    reviews = pd.read_csv(f'{str(get_project_root())}/whatif/experiments/datasets/amazon-reviews/reviews.csv.gz', compression='gzip', index_col=0)
    products = pd.read_csv(f'{str(get_project_root())}/whatif/experiments/datasets/amazon-reviews/products.csv', index_col=0)
    categories = pd.read_csv(f'{str(get_project_root())}/whatif/experiments/datasets/amazon-reviews/categories.csv', index_col=0)
    ratings = pd.read_csv(f'{str(get_project_root())}/whatif/experiments/datasets/amazon-reviews/ratings.csv', index_col=0)
