...
from whatif.experiments.product_images_shapley_naive import create_corrupt_data
...
def measure_shapley_opt_exec_time(corruption_fraction, num_iterations, use_shapley_weighting, shapley_value_k,
    ...
    """),
                           setup=cleandoc(f"""
    from whatif.experiments.product_images_shapley_naive import create_corrupt_data
    from whatif.experiments.product_images_shapley_opt import execute_image_pipeline_w_shapley_opt
    import pandas as pd
